package org.pampanet.upgrade.challenge.config;
...
@Configuration
@EnableJpaRepositories("org.pampanet.upgrade.challenge.repository")
@PropertySource("persistence-campsite.properties")
@ComponentScan({ "org.pampanet.upgrade.challenge.model" })
